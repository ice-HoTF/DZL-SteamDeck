...
read -p $'\n
 Press Enter to Delete All DayZ Mods.' foo
      	    ...
      	    rm -rf /home/$USER/.steam/steam/debian-installation/steamapps/workshop/content/221100/*
     	    sleep 0.1
            rm -rf /home/$USER/.steam/steam/debian-installation/steamapps/workshop/downloads/*
            sleep 0.1
     	    rm -r -f /home/$USER/.steam/steam/debian-installation/steamapps/common/DayZ/@*
...
if [ ! -d "${1}" ] ; then
mkdir "/home/$USER/.steam/steam/steam/steamapps/workshop/content/221100"
fi
}
...
sleep 0.25
if [ -f "/home/$USER/.steam/steam/debian-installation/steamapps/workshop/appworkshop_221100.acf" ] ; then
rm /home/$USER/.steam/steam/debian-installation/steamapps/workshop/appworkshop_221100.acf  
fi
sleep 0.25
if [ -f "/home/$USER/.steam/steam/debian-installation/steamapps/workshop/appworkshop_241100.acf" ] ; then
rm /home/$USER/.steam/steam/debian-installation/steamapps/workshop/appworkshop_241100.acf  
fi
sleep 0.25
...
case $number in
 ...
 Checking Server Mods .." 
            sleep 0.25
            rm -rf /home/$USER/.steam/steam/debian-installation/steamapps/workshop/content/downloads/*
            rm -r -f /home/$USER/.steam/steam/debian-installation/steamapps/common/DayZ/@*
            sleep 0.1;;
    [2])
    submenu2
...
\n' foo
	    ...
	    rm -rf /home/$USER/.steam/steam/debian-installation/steamapps/workshop/content/221100/${modid}            
	    rm -r -f /home/$USER/.steam/steam/debian-installation/steamapps/common/DayZ/@*
	    continue
	   done
            sleep 0.1
...
if (( missing == 1 )); then
 ...
 Please Wait While Steam Download The Mods."
   sleep 10
   until [ ! -d "/home/$USER/.steam/steam/debian-installation/steamapps/workshop/temp/221100" ] && sleep 5 && [ ! -d "/home/$USER/.steam/steam/debian-installation/steamapps/workshop/temp/221100" ]; 
   do
   echo -e "\n 
